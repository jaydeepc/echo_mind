...
def main():
    ...
    image_upload_column, pdf_upload_column = st.columns(2)
    
    with image_upload_column:
        uploaded_image = st.file_uploader("Upload an image file", type=["jpg", "jpeg", "png"])
    with pdf_upload_column:
        uploaded_pdf = st.file_uploader("Upload a pdf file", accept_multiple_files=True, key="pdf_upload", type=["pdf"], on_change=toggle_pdf_chat)
